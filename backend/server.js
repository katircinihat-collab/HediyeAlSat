...
const listingBoostRoutes =
    require("./routes/listingBoostRoutes");
const sponsorStoreRoutes =
    require("./routes/sponsorStoreRoutes");
...
app.use("/api/sponsor-store", sponsorStoreRoutes);
